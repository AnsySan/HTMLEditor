...
import ru.AnsySan.actions.*;
import ru.AnsySan.listeners.TextEditMenuListener;
import ru.AnsySan.listeners.UndoMenuListener;
...
public class MenuHelper {
    ...
    public static void initAlignMenu(View view, JMenuBar menuBar) {
        JMenu alignMenu = new JMenu("Leveling");
        menuBar.add(alignMenu);

        addMenuItem(alignMenu, new StyledEditorKit.AlignmentAction("On the left edge", StyleConstants.ALIGN_LEFT));
        addMenuItem(alignMenu, new StyledEditorKit.AlignmentAction("In the center", StyleConstants.ALIGN_CENTER));
        addMenuItem(alignMenu, new StyledEditorKit.AlignmentAction("On the right edge", StyleConstants.ALIGN_RIGHT));
    ...
    public static void initStyleMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(styleMenu, "Emphasized", new StyledEditorKit.UnderlineAction());
        ...
        addMenuItem(styleMenu, "Crossed put", new StrikeThroughAction());
    ...
    public static void initEditMenu(View view, JMenuBar menuBar) {
        ...
        addMenuItem(editMenu, "Insert", new DefaultEditorKit.PasteAction());
